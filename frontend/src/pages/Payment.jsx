...
const Payment = () => {
  return (
    <div className='paymentParent h-screen w-screen flex justify-center items-center bg-gray-400' >
        <div className="paymentCard h-2/4 w-1/4 bg-white flex flex-col items-center ">
            ...
            <div className="receiverInfo w-full mb-12 flex flex-col gap-6">
              ...
              <InputBox prop={{type:"text", class:"ml-14 border-2 w-5/6 text-xl px-2 py-1 rounded-xl outline-none", placeholder:"input name", onChange:()=>{}}} ></InputBox>
            </div>
